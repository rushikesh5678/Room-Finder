...
public class BFlatFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_b_flat2, container, false);
        ...
        myRef=database.getReference().child("Admin").child(userid).child("City").child("Baramati").child("Flat");
