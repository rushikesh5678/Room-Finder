...
public class BFlatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_b_flat, container, false);
        ...
        myRef=database.getReference().child("PGs").child("Baramati").child("Flat");
