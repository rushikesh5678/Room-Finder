...
public class BRoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_b_room, container, false);
        ...
        myRef=database.getReference().child("PGs").child("Baramati").child("Room");
