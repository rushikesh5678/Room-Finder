...
import com.example.pguser.punefragments.PFlatFragment;
import com.example.pguser.punefragments.PRoomFragment;
...
public class PuneActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    PRoomFragment room = new PRoomFragment();
    PFlatFragment flat = new PFlatFragment();
