...
import com.example.pguser.mumbaifragments.MFlatFragment;
import com.example.pguser.mumbaifragments.MRoomFragment;
...
public class MumbaiActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    MRoomFragment room = new MRoomFragment();
    MFlatFragment flat = new MFlatFragment();
