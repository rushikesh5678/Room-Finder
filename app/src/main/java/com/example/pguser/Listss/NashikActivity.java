...
import com.example.pguser.nashikfragments.NFlatFragment;
import com.example.pguser.nashikfragments.NRoomFragment;
...
public class NashikActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    NRoomFragment room = new NRoomFragment();
    NFlatFragment flat = new NFlatFragment();
