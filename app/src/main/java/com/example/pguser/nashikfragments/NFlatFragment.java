...
public class NFlatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_n_flat, container, false);
        ...
        myRef=database.getReference().child("PGs").child("Nashik").child("Flat");
