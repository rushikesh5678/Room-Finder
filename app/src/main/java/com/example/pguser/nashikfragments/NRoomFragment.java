package com.example.pguser.nashikfragments;
...
public class NRoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_n_room, container, false);
        ...
        myRef=database.getReference().child("PGs").child("Nashik").child("Room");
