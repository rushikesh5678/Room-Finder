...
public class PFlatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_p_flat, container, false);
        ...
        myRef=database.getReference().child("PGs").child("Pune").child("Flat");
