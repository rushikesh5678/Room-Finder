package com.example.pguser.punefragments;
...
public class PRoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_p_room, container, false);
        ...
        myRef=database.getReference().child("PGs").child("Pune").child("Room");
