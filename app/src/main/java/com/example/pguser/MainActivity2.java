...
import com.example.pguser.Fragments.HomeFragment2;
import com.example.pguser.Fragments.ProfileFragment2;
...
public class MainActivity2 extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    HomeFragment2 home = new HomeFragment2();
    ProfileFragment2 profile = new ProfileFragment2();
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.logout :
                ...
                Toast.makeText(MainActivity2.this, "User Successfully LogOut..", Toast.LENGTH_SHORT).show();
